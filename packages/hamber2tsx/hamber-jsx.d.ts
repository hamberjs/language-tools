...
declare namespace hamberHTML {
  ...
  function createElement<Elements extends IntrinsicElements, Key extends keyof Elements>(
    // "undefined | null" because of <hamber:element>
  ...
  type EventHandler<E extends Event = Event, T extends EventTarget = HTMLElement> =
    hamber.JSX.EventHandler<E,T>;

  type ClipboardEventHandler<T extends EventTarget> = hamber.JSX.ClipboardEventHandler<T>;
  type CompositionEventHandler<T extends EventTarget> = hamber.JSX.CompositionEventHandler<T>;
  type DragEventHandler<T extends EventTarget> = hamber.JSX.DragEventHandler<T>;
  type FocusEventHandler<T extends EventTarget> = hamber.JSX.FocusEventHandler<T>;
  type FormEventHandler<T extends EventTarget> = hamber.JSX.FormEventHandler<T>;
  type ChangeEventHandler<T extends EventTarget> = hamber.JSX.ChangeEventHandler<T>;
  type KeyboardEventHandler<T extends EventTarget> = hamber.JSX.KeyboardEventHandler<T>;
  type MouseEventHandler<T extends EventTarget> = hamber.JSX.MouseEventHandler<T>;
  type TouchEventHandler<T extends EventTarget> = hamber.JSX.TouchEventHandler<T>;
  type PointerEventHandler<T extends EventTarget> = hamber.JSX.PointerEventHandler<T>;
  type UIEventHandler<T extends EventTarget> = hamber.JSX.UIEventHandler<T>;
  type WheelEventHandler<T extends EventTarget> = hamber.JSX.WheelEventHandler<T>;
  type AnimationEventHandler<T extends EventTarget> = hamber.JSX.AnimationEventHandler<T>;
  type TransitionEventHandler<T extends EventTarget> = hamber.JSX.TransitionEventHandler<T>;
  type MessageEventHandler<T extends EventTarget> = hamber.JSX.MessageEventHandler<T>;

  // For backwards-compatibility and ease-of-use, in case someone enhanced the typings from import('./hamber-html-do-not-use').HTMLAttributes/SVGAttributes
  ...
  type HTMLProps<Property extends string, Override> =
    ...
    Omit<
      ...
      Omit<import('./hamber-html-do-not-use').HamberHTMLElements[Property], keyof EventsWithColon<hamber.JSX.IntrinsicElements[Property & string]>> & EventsWithColon<hamber.JSX.IntrinsicElements[Property & string]>,
      keyof Override
    > & Override;
  /**
   * @internal do not use
  ...
  interface IntrinsicElements extends Omit<RemoveIndex<hamber.JSX.IntrinsicElements>, keyof RemoveIndex<import('./hamber-html-do-not-use').HamberHTMLElements>> {
    ...
    // Hamber specific
    'hamber:window': HTMLProps<'hamber:window', HTMLAttributes>;
    'hamber:body': HTMLProps<'hamber:body', HTMLAttributes>;
...
declare namespace hamber.JSX {
    ...
    interface HamberInputProps extends HTMLProps<HTMLInputElement> {
      group?: any | undefined | null;
      files?: FileList | undefined | null;
      indeterminate?: boolean | undefined | null;
    }

    interface HamberWindowProps  {
      ...
      // Transformed from on:hamberkit:xy
      'onhamberkit:start'?: EventHandler<CustomEvent, Window> | undefined | null;
      'onhamberkit:navigation-start'?: EventHandler<CustomEvent, Window> | undefined | null;
      'onhamberkit:navigation-end'?: EventHandler<CustomEvent, Window> | undefined | null;
    ...
    interface RamberAnchorProps {
        // transformed from ramber:noscroll so it should be camel case
        ramberNoscroll?: true | undefined | null;
        ramberPrefetch?: true | undefined | null;
    }

    interface HamberKitAnchorProps {
        // transformed from hamberkit:noscroll so it should be camel case
        hamberkitNoscroll?: true | undefined | null;
        hamberkitPrefetch?: true | undefined | null;
        hamberkitReload?: true | undefined | null;
    }

    interface HamberMediaTimeRange {
        start: number;
        end: number;
    }

    interface HamberMediaProps {
        readonly duration?: number | undefined | null;
        readonly buffered?: HamberMediaTimeRange[] | undefined | null;
        readonly played?: HamberMediaTimeRange[] | undefined | null;
        readonly seekable?: HamberMediaTimeRange[] | undefined | null;
    ...
    interface HamberVideoProps extends HamberMediaProps {
    ...
    interface IntrinsicElements {
      // HTML
      a: HTMLProps<HTMLAnchorElement> & RamberAnchorProps & HamberKitAnchorProps;
      ...
      audio: HTMLProps<HTMLAudioElement> & HamberMediaProps;
      ...
      video: HTMLProps<HTMLVideoElement> & HamberVideoProps;
      ...
      // Hamber specific
      hamberwindow: HTMLProps<Window> & HamberWindowProps;
      hamberbody: HTMLProps<HTMLElement>;
      hamberfragment: { slot?: string; };
      hamberoptions: { [name: string]: any };
      hamberhead: { [name: string]: any };
      hamberelement: { 'this': string | undefined | null; } & HTMLProps<any> & SVGProps<any> & RamberAnchorProps & HamberKitAnchorProps;
      // Needed due to backwards compatibility type which hits these
      'hamber:window': HTMLProps<Window> & HamberWindowProps;
      'hamber:body': HTMLProps<HTMLElement>;
      'hamber:fragment': { slot?: string; };
      'hamber:options': { [name: string]: any };
      'hamber:head': { [name: string]: any };
