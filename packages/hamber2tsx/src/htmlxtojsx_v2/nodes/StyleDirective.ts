...
/**
 * style:xx         --->  __hamberts_2_ensureType(String, Number, xx);
 * style:xx={yy}    --->  __hamberts_2_ensureType(String, Number, yy);
 * style:xx="yy"    --->  __hamberts_2_ensureType(String, Number, "yy");
 * style:xx="a{b}"  --->  __hamberts_2_ensureType(String, Number, `a${b}`);
 */
export function handleStyleDirective(
    ...
    const ensureType = '__hamberts_2_ensureType(String, Number, ';
