...
import { TemplateNode, Text } from 'hamber/types/compiler/interfaces';
...
import { handleHamberTag } from './nodes/hamber-tag';
...
/**
 * Walks the HTMLx part of the Hamber component
            ...
            try {
                switch (node.type) {
                    ...
                    case 'InlineComponent':
                        ...
                        break;
                    case 'Element':
                        if (node.name === 'hamber:element') {
                            handleHamberTag(htmlx, str, node);
                        }
                        templateScopeManager.componentOrSlotTemplateOrElementEnter(node);
                        handleElement(
                            htmlx,
