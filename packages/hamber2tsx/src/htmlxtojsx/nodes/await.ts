...
export function handleAwaitPending(
    ...
    str.appendLeft(pendingEnd, '__hamberts_1_awaitThen(_$$p, () => {<>');
}
...
export function handleAwaitThen(
    ...
    // __hamberts_1_awaitThen(_$$p, (value) => {(possibleIfCondition && )<>
    ...
    if (awaitBlock.value) {
        str.overwrite(thenStart, awaitBlock.value.start, '__hamberts_1_awaitThen(_$$p, (');
        ...
        const awaitThenFn = '__hamberts_1_awaitThen(_$$p, () => {';
