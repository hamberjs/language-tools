...
import { HamberConfig, configLoader } from './configLoader';
import { HTMLDocument } from 'vscode-html-languageservice';
import { Range } from 'vscode-languageserver';

/**
 * Represents a text document contains a hamber component.
 */
export class Document extends WritableDocument {
    ...
    configPromise: Promise<HamberConfig | undefined>;
    config?: HamberConfig;
    html!: HTMLDocument;
    /**
    ...
    private updateDocInfo() {
        ...
        const update = (config: HamberConfig | undefined) => {
