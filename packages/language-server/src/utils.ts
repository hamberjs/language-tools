...
/**
 * Given a path like foo/bar or foo/bar.hamber , returns its last path
 * (bar or bar.hamber in this example).
 */
 ...
 * hover/ completion info for Hamber components like `Option` which have
 * the same name like a html tag.
 *
 * Also, hamber directives like action and event modifier only work
